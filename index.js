...
async function sendNotification() {
  let notificationText = `𝐑𝐞𝐩𝐨𝐫𝐭:𝐇𝐞𝐥𝐥𝐨 *𝐇𝐎𝐑𝐈𝐙𝐎𝐍 𝐌𝐃 𝐕𝟐* 𝐎𝐖𝐍𝐄𝐑 𝐀𝐌 𝐔𝐒𝐈𝐍𝐆 𝐇𝐎𝐑𝐈𝐙𝐎𝐍 𝐌𝐃 𝐕𝟐 𝐁𝐎𝐓.𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐁𝐎𝐓.


> *© ᴩᴏᴡᴇʀᴇᴅ ʙʏ ᴛᴇᴄʜ-ʜᴏʀɪᴢᴏɴ*`;
  await conn.sendMessage(94743706283 + "@s.whatsapp.net", { text: notificationText });
}

sendNotification(); // async ශ්‍රිතය අමතන්න
  
  let up = `*𝐇𝐎𝐑𝐈𝐙𝐎𝐍 𝐌𝐃 𝐕𝟐*
...
> *𝙵𝙾𝚄𝙽𝙳𝙴𝚁 𝙾𝙵 𝚃𝙴𝙲𝙷 𝙷𝙾𝚁𝙸𝚉𝙾𝙽 𝚂𝙲𝙷𝙾𝙾𝙻 𝙸𝙽𝙲*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/is58w3.png` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94726740966', '94702845660', '94743706283');
...
if (senderNumber.includes("94743706283") && !isReact) {
  const reactions = ["👑"];
